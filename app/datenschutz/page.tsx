...
export const metadata: Metadata = {
  title: "Datenschutzerklärung - Die Bianco",
  description:
    "Datenschutzerklärung des Friseursalons Die Bianco - Informationen zum Umgang mit Ihren personenbezogenen Daten.",
}

export default function DatenschutzPage() {
  return (
    <main className="flex min-h-screen flex-col items-center justify-between py-12 px-4 md:px-6 lg:px-8">
      <div className="container mx-auto px-6 py-8 md:px-8 lg:px-10 max-w-4xl">
        <h1 className="text-4xl font-bold mb-8 text-center text-[#333]">Datenschutzerklärung</h1>

        {/* Section 1 */}
        <div className="bg-white/90 rounded-lg shadow-lg p-6 mb-6 border border-gray-200">
          <h2 className="text-2xl font-bold mb-4 text-[#333]">1. Datenschutz auf einen Blick</h2>

          <div className="mb-6">
            <h3 className="text-xl font-semibold mb-3 text-[#333]">Allgemeine Hinweise</h3>
          ...
          <div className="mb-6">
            <h3 className="text-xl font-semibold mb-3 text-[#333]">Datenerfassung auf dieser Website</h3>

            <h4 className="text-lg font-medium mb-2 text-[#333]">
            ...
            <h4 className="text-lg font-medium mb-2 text-[#333]">Wie erfassen wir Ihre Daten?</h4>
            <p className="text-gray-700 mb-4">
            ...
            <h4 className="text-lg font-medium mb-2 text-[#333]">Wofür nutzen wir Ihre Daten?</h4>
            <p className="text-gray-700 mb-4">
            ...
            <h4 className="text-lg font-medium mb-2 text-[#333]">Welche Rechte haben Sie bezüglich Ihrer Daten?</h4>
            <p className="text-gray-700 mb-4">
          ...
          <div className="mb-6">
            <h3 className="text-xl font-semibold mb-3 text-[#333]">Analyse-Tools und Tools von Drittanbietern</h3>
            <p className="text-gray-700 mb-4">
        ...
        {/* Section 2 */}
        <div className="bg-white/90 rounded-lg shadow-lg p-6 mb-6 border border-gray-200">
          <h2 className="text-2xl font-bold mb-4 text-[#333]">2. Allgemeine Hinweise und Pflichtinformationen</h2>

          <div className="mb-6">
            <h3 className="text-xl font-semibold mb-3 text-[#333]">Datenschutz</h3>
            <p className="text-gray-700 mb-4">
          ...
          <div className="mb-6">
            <h3 className="text-xl font-semibold mb-3 text-[#333]">Hinweis zur verantwortlichen Stelle</h3>
            <p className="text-gray-700 mb-4">
          ...
          <div className="mb-6">
            <h3 className="text-xl font-semibold mb-3 text-[#333]">Speicherdauer</h3>
            <p className="text-gray-700">
          ...
          <div className="mb-6">
            <h3 className="text-xl font-semibold mb-3 text-[#333]">Empfänger von personenbezogenen Daten</h3>
            <p className="text-gray-700">
          ...
          <div className="mb-6">
            ...
            <div className="bg-red-50 border border-red-200 p-4 rounded">
              <p className="text-gray-700 font-medium">
                ...
                VERARARBEITUNG DIENT DER GELTENDMACHUNG, AUSÜBUNG ODER VERTEIDIGUNG VON RECHTSANSPRÜCHEN (WIDERSPRUCH
          ...
          <div className="mb-6">
            <h3 className="text-xl font-semibold mb-3 text-[#333]">Recht auf Datenübertragbarkeit</h3>
            <p className="text-gray-700">
          ...
          <div className="mb-6">
            <h3 className="text-xl font-semibold mb-3 text-[#333]">Auskunft, Berichtigung und Löschung</h3>
            <p className="text-gray-700">
          ...
          <div className="mb-6">
            <h3 className="text-xl font-semibold mb-3 text-[#333]">Recht auf Einschränkung der Verarbeitung</h3>
            <p className="text-gray-700 mb-4">
          ...
          <div className="mb-6">
            <h3 className="text-xl font-semibold mb-3 text-[#333]">SSL- bzw. TLS-Verschlüsselung</h3>
            <p className="text-gray-700 mb-4">
        ...
        {/* Section 3 */}
        <div className="bg-white/90 rounded-lg shadow-lg p-6 mb-6 border border-gray-200">
          <h2 className="text-2xl font-bold mb-4 text-[#333]">3. Datenerfassung auf dieser Website</h2>

          <div className="mb-6">
            <h3 className="text-xl font-semibold mb-3 text-[#333]">Cookies</h3>
            <p className="text-gray-700 mb-4">
          ...
          <div className="mb-6">
            <h3 className="text-xl font-semibold mb-3 text-[#333]">Anfrage per E-Mail, Telefon oder Telefax</h3>
            <p className="text-gray-700 mb-4">
        ...
        {/* Section 4 */}
        <div className="bg-white/90 rounded-lg shadow-lg p-6 mb-6 border border-gray-200">
          <h2 className="text-2xl font-bold mb-4 text-[#333]">4. Plugins und Tools</h2>

          <div className="mb-6">
            <h3 className="text-xl font-semibold mb-3 text-[#333]">Google Maps</h3>
            <p className="text-gray-700 mb-4">
