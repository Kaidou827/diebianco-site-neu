...
const testimonials = [
  {
    name: "Kundin aus Krefeld",
    text: "Ich wollte mein Grau nicht mehr verstecken – jetzt sieht es modern, weich und absolut stimmig aus. Ich fühle mich wieder wie ich selbst.",
  },
  {
    name: "Stammkundin",
    text: "Das Ergebnis ist natürlich, elegant und super pflegeleicht. Genau die Beratung, die ich mir gewünscht habe.",
  },
]

const faq = [
  {
    frage: "Wie lange dauert ein Grey-Blending-Termin?",
    antwort: "Je nach Ausgangslage meist zwischen 2 und 4 Stunden inklusive Beratung und Finish.",
  },
  {
    frage: "Wie oft muss ich nachfärben?",
    antwort:
      "Viele Kundinnen kommen in größeren Intervallen, da der Übergang bewusst weich und natürlich aufgebaut wird.",
  },
  {
    frage: "Was kostet Grey Blending?",
    antwort:
      "Der Preis hängt von Haarlänge, Ausgangston und Ziel ab. Du bekommst vorab eine persönliche Einschätzung.",
  },
  {
    frage: "Für wen ist Grey Blending geeignet?",
    antwort:
      "Ideal für alle, die graues Haar elegant integrieren und einen modernen, pflegeleichten Look möchten.",
  },
]
      ...
      <main className="container mx-auto px-4 md:px-6">
        ...
        <section className="pt-10 md:pt-16 pb-6 text-center max-w-2xl mx-auto">
          <h1 className="font-serif text-3xl md:text-5xl tracking-tight leading-tight">
            Deine persönliche <span className="text-[#D4C6A6]">Grey-Blending-Beratung</span>
          </h1>
          <p className="mt-3 text-lg text-white/85">
            Unverbindlich anfragen – Teresa berät dich persönlich zu deinem individuellen Grey-Blending-Look.
          </p>
        ...
        <section id="kontakt-formular" className="scroll-mt-24 pb-14">
          <div className="mx-auto max-w-2xl rounded-2xl bg-[#F5F1E8] p-6 md:p-8 shadow-[0_24px_60px_-20px_rgba(0,0,0,0.35)] ring-1 ring-black/5">
            <h2 className="font-serif text-2xl text-[#2C2C2C]">Beratungstermin anfragen</h2>
        ...
        {/* VORHER / NACHHER */}
        <section className="pb-14 max-w-3xl mx-auto">
          <h2 className="font-serif text-2xl md:text-3xl mb-6 text-center">Grey-Blending-Ergebnis</h2>
        ...
        {/* TESTIMONIALS */}
        <section className="pb-14 max-w-4xl mx-auto">
        ...
        {/* FAQ */}
        <section className="pb-14 max-w-3xl mx-auto">
          <h2 className="font-serif text-2xl md:text-3xl mb-6 text-center">Häufige Fragen</h2>
          <div className="space-y-4">
            {faq.map((f) => (
              <div key={f.frage} className="rounded-xl border border-white/10 bg-black/20 p-5">
                <h3 className="text-[#D4C6A6] font-semibold mb-1">{f.frage}</h3>
                <p className="text-white/85 text-sm leading-relaxed">{f.antwort}</p>
              </div>
            ))}
          </div>
        </section>
